    ...
    module Main
      class Defined < Command
        ...
        def execute
          ...
          query = Wheelhouse::Queries::Server.new(app_config.connstring)
      ...
      class Migrate < Command
        ...
        def execute
          ...
          Wheelhouse.log_at(Logger::DEBUG) do
            Sequel::Migrator.run(Wheelhouse.databases[app_config.connstring], directory)
          end
        end
      end
    end
    ...
    module Servers
      class Add < Command
        ...
        def execute
          ...
          store = Wheelhouse::Persisters::Server.new(app_config.connstring)
      ...
      class List < Command
        def execute
          require 'wheelhouse/queries/server'
          Wheelhouse::Queries::Server.new(app_config.connstring).print
        end
      end
